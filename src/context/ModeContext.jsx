...
export const ModeProvider = ({ children }) => {
  ...
  const changeMode = (color) => {
    if (color === "light") {
      ...
      document.querySelectorAll(".settings-container .phone-items svg")[0].style.color = "#333"
      document.querySelectorAll(".settings-container .phone-items svg")[1].style.color = "#333"
      document.querySelectorAll(".settings-container .phone-items svg")[2].style.color = "#333"
      ...
      document.querySelector(".streaming p").style.color = "#fffdd0"
      ...
      document.querySelector(".streaming p").style.textShadow = "2px 2px 0px #000"
      ...
      document.querySelectorAll(".phone-items svg")[0].style.color = "#fffdd0"
      document.querySelectorAll(".phone-items svg")[1].style.color = "#fffdd0"
      document.querySelectorAll(".phone-items svg")[2].style.color = "#fffdd0"
      ...
      document.querySelectorAll(".settings-container .phone-items svg")[0].style.color = "#fffdd0"
      document.querySelectorAll(".settings-container .phone-items svg")[1].style.color = "#fffdd0"
      document.querySelectorAll(".settings-container .phone-items svg")[2].style.color = "#fffdd0"
      ...
      document.querySelector(".streaming p").style.color = "#333"
      ...
      document.querySelector(".streaming p").style.textShadow = "2px 2px 0px #8c8c8c"
      ...
      document.querySelectorAll(".phone-items svg")[0].style.color = "#333"
      document.querySelectorAll(".phone-items svg")[1].style.color = "#333"
      document.querySelectorAll(".phone-items svg")[2].style.color = "#333"
