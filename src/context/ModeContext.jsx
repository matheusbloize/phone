...
export const ModeProvider = ({ children }) => {
  ...
  const changeMode = (color) => {
    if (color === "light") {
      ...
      document.querySelector(".exchange p").style.color = "#fffdd0"
      ...
      document.querySelector(".exchange p").style.textShadow = "2px 2px 0px #000"
      ...
      document.querySelector(".exchange p").style.color = "#333"
      ...
      document.querySelector(".exchange p").style.textShadow = "2px 2px 0px #8c8c8c"
